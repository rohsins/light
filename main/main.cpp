...
static const char * deviceUdi = "lightSwitch00003";
...
void subListener(esp_mqtt_event_handle_t event) {
    ...
    if (strncmp(event->topic, "RTSR&D/baanvak/sub/lightSwitch00003", event->topic_len) == 0) {
...
extern "C" void app_main() {
    ...
    *mqttInstance->Subscribe("RTSR&D/baanvak/sub/lightSwitch00003", 2) = subListener;
